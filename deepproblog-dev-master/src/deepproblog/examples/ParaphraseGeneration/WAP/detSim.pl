...
%-----------------------------------------------------------
detectSim(WP1, WP2, Equation1, Equation2, 1) :-  
    net1([WP1, 'n0'], Cat1_n0 ),
    net1([WP1, 'n1'], Cat1_n1),
    net2([WP1], Cat1_query),
    ...
    net1([WP2, 'n1'], Cat2_n1),
    net2([WP2], Cat2_query), 
    Cat2_query \= Cat2_n0, Cat2_query \= Cat2_n1, Cat2_n1 \= Cat2_n0,
    getSchema(Cat1_n0, Cat1_n1, Cat1_query, Schema_Type1, Equation1_p),
    getSchema(Cat2_n0, Cat2_n1, Cat2_query, Schema_Type2, Equation2_p),
    Schema_Type1 == Schema_Type2,
    checkequal(Equation1, Equation1_p),
    checkequal(Equation2, Equation2_p). 
    
%-----------------------------------------------------------
detectSim(WP1, WP2, Equation1, Equation2, 0) :-  
    net1([WP1, 'n0'], Cat1_n0 ), 
    net1([WP1, 'n1'], Cat1_n1),
    net2([WP1], Cat1_query),
    Cat1_query \= Cat1_n0, Cat1_query \= Cat1_n1, Cat1_n1 \= Cat1_n0,
