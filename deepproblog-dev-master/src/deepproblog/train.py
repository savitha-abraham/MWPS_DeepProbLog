...
class TrainObject(object):
    ...
    def train(
        ...
        **kwargs
        ...
        #print("Model solver::",self.model.solver)
        ...
        while not (stop_criterion.is_stop(self) or self.interrupt):
            ...
            for batch in loader:
                #print("Batch:", batch, type(batch[0]))
                if self.interrupt:
                    break
                self.i += 1
                self.model.train()
            ...
            self.epoch += 1
            print("Writing snapshot after epoch:")
            filename = '/home/savitha/Documents/MWPS/DPL_New/deepproblog-dev-master/src/deepproblog/examples/ParaphraseGeneration/WAP/snapshot/20Pre-PD_E' + str(self.epoch)+'.pth'
